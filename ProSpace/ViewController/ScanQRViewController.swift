...
class ScanQRViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    func found(code: String) {
        let arrIDMachine = UserProfileDataStore.getLocallySavedArrMachine() ?? []
        for item in arrIDMachine {
            if let machine = UserProfileDataStore.getLocallySavedMachineByID(id: item), machine.qrNumber == code {
